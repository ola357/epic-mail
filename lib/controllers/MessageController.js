          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                userId = req.user._id;
                _context.next = 3;
                return _db.default.query('SELECT * FROM messages WHERE receiverid = ($1) ORDER BY createdon DESC', [userId]);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                status = "sent";
                _context2.next = 4;
                return _db.default.query('SELECT * FROM messages WHERE receiverid = ($1) AND status = ($2) ORDER BY createdon DESC', [userId, status]);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                userId = req.user._id;
                _context3.next = 3;
                return _db.default.query('SELECT * FROM messages WHERE senderid = ($1) ORDER BY createdon DESC', [userId]);
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 10:
                ...
                _context4.next = 14;
                return _db.default.query('UPDATE messages SET status = ($1) WHERE id = ($2) RETURNING *', ["read", mailId]);
