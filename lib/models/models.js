...
function () {
  ...
  regeneratorRuntime.mark(function _callee() {
    var createUsersTable, createMessagesTable, createGroupsTable, createGroupMembersTable;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 6;
            return _db.default.query("".concat(createUsersTable, " ").concat(createMessagesTable, " ").concat(createGroupsTable, " ").concat(createGroupMembersTable));
